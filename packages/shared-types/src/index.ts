...
export const investigationStepTypes = ['tool_call', 'reasoning', 'decision'] as const;
export type InvestigationStepType = (typeof investigationStepTypes)[number];

export const investigationStepStatuses = ['pending', 'success', 'failed', 'skipped'] as const;
...
export const entityKinds = ['requestId', 'userId', 'serviceName', 'deploymentId'] as const;
export type EntityKind = (typeof entityKinds)[number];

export const signalCategories = ['symptom', 'cause', 'correlation', 'change', 'impact'] as const;
...
export const planStepStatuses = ['pending', 'ready', 'in_progress', 'completed', 'skipped'] as const;
export type PlanStepStatus = (typeof planStepStatuses)[number];

export const finalReportStatuses = ['resolved', 'mitigated', 'needs_handoff', 'inconclusive'] as const;
...
export type InitEndpointContract = EndpointContract<'/init', InitRequest, InitResponse>;
export type PlanEndpointContract = EndpointContract<'/plan', PlanRequest, PlanResponse>;
export type ExecuteEndpointContract = EndpointContract<'/execute', ExecuteRequest, ExecuteResponse>;
export type EvaluateEndpointContract = EndpointContract<'/evaluate', EvaluateRequest, EvaluateResponse>;
export type FinalizeEndpointContract = EndpointContract<'/finalize', FinalizeRequest, FinalizeResponse>;
